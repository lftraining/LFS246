...
@Configuration
public class ProductChannelSubscription {
	...
	@Bean
	public Consumer<Message<Object>> blockCS(){
		return this::doBlockProductCS;
	}
	
	private void doBlockProductCS(Message<Object> msg) {
		...
		if(orderDetails != null && orderDetails.getProdId() != null) {
			LOGGER.info("product-service-es :: Order Recieved CS:: " + orderDetails);
			LOGGER.info("product-service-es :: Order Status CS:: " +  orderDetails.getOrderStatus());
	        ...
	        LOGGER.info("product-service-es :: order details CS :: " + productDetails);
        }
    }
